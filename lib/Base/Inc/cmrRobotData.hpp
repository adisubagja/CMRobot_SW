...
struct cmrLinkData
{
    cmrLinkData():m_linkMass(0)
    {
        m_inertia=cmrMatrix3d::Constant(1e-6);
    }
    ...
    void printInfo(){
        ...
        std::cout<<"geometry_rot:"<<std::endl<<m_geometryOrigin.rot<<std::endl;
    }
};
...
struct cmrJointData
{
    cmrJointData():m_jointDoFs(0),m_maxEffort(0),m_maxVelocity(0),m_damping(0),
    ...
    void printInfo(){
        ...
        std::cout<<"jointOrigin_rot:"<<std::endl<<m_jointOrigin.rot<<std::endl;
