...
static void test_simple_concatenation(const Eigen::SyclDevice &sycl_device) {
  ...
  sycl_device.memcpyHostToDevice(gpu_in1_data, left.data(),
                                 (left.dimensions().TotalSize()) *
                                     sizeof(DataType));
  sycl_device.memcpyHostToDevice(gpu_in2_data, right.data(),
  ...
  sycl_device.memcpyDeviceToHost(concatenation1.data(), gpu_out_data1,
                                 (concatenation1.dimensions().TotalSize()) *
                                     sizeof(DataType));
  ...
  sycl_device.memcpyDeviceToHost(concatenation2.data(), gpu_out_data2,
                                 (concatenation2.dimensions().TotalSize()) *
                                     sizeof(DataType));
  ...
  sycl_device.memcpyDeviceToHost(concatenation3.data(), gpu_out_data3,
                                 (concatenation3.dimensions().TotalSize()) *
                                     sizeof(DataType));
...
static void test_concatenation_as_lvalue(const Eigen::SyclDevice &sycl_device) {
  ...
  sycl_device.memcpyHostToDevice(gpu_in2_data, right.data(),
                                 (right.dimensions().TotalSize()) *
                                     sizeof(DataType));
  sycl_device.memcpyHostToDevice(gpu_out_data, result.data(),
                                 (result.dimensions().TotalSize()) *
                                     sizeof(DataType));

  //  t1.concatenate(t2, 0) = result;
  gpu_in1.concatenate(gpu_in2, 0).device(sycl_device) = gpu_out;
  sycl_device.memcpyDeviceToHost(left.data(), gpu_in1_data,
                                 (left.dimensions().TotalSize()) *
                                     sizeof(DataType));
  sycl_device.memcpyDeviceToHost(right.data(), gpu_in2_data,
                                 (right.dimensions().TotalSize()) *
                                     sizeof(DataType));
