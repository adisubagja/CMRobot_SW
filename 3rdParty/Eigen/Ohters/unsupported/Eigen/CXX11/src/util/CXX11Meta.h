...
struct h_array_reduce {
  ...
  run(array<T, N> arr, T identity) -> decltype(
...
constexpr EIGEN_STRONG_INLINE auto
h_array_apply_and_reduce(array<A, N> arr, numeric_list<int, n...>) -> decltype(
