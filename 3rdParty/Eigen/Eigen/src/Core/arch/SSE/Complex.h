...
template <> EIGEN_STRONG_INLINE Packet2cf pnot<Packet2cf>(const Packet2cf &a) {
  return Packet2cf(pnot(Packet4f(a.v)));
}
...
template <> EIGEN_STRONG_INLINE Packet1cd pnot<Packet1cd>(const Packet1cd &a) {
  return Packet1cd(pnot(Packet2d(a.v)));
}
template <>
