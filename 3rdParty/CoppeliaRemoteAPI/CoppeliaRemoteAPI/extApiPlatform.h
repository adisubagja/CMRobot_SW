...
#define SOCKET_HEADER_LENGTH                                                   \
  6 /* WORD0=1 (to detect endianness), WORD1=packetSize,                       \
       WORD2=packetsLeftToRead */
...
simxUChar extApi_connectToServer_socket(simxInt clientID,
                                        const simxChar *theConnectionAddress,
                                        simxInt theConnectionPort);
