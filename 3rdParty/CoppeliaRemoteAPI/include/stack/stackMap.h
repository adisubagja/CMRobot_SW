...
public:
  ...
  bool contains(const char *key, int theType = -1, size_t theMinSizeIfArray = 0,
                bool onlyNumbersInArray = false);
  bool contains(int key, int theType = -1, size_t theMinSizeIfArray = 0,
                bool onlyNumbersInArray = false);
  bool contains(bool key, int theType = -1, size_t theMinSizeIfArray = 0,
                bool onlyNumbersInArray = false);
