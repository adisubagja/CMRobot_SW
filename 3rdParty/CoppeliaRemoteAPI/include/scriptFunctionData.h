...
public:
  ...
  bool readDataFromStack(int stackHandle, const int *expectedArguments,
  ...
  bool readDataFromStack_scriptFunctionCall(int stackHandle,
...
protected:
  bool _readData(int stack, const int *expectedArguments,
                 int requiredArgumentCount, const char *functionName,
