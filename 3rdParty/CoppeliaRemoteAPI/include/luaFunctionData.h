...
public:
  ...
  //------------------------
  static void getInputDataForFunctionRegistration(const int *dat,
                                                  std::vector<int> &outDat);
  bool readDataFromLua(const SLuaCallBack *p, const int *expectedArguments,
  ...
  void writeDataToLua_luaFunctionCall(SLuaCallBack *p,
                                      const int *expectedArguments);
  bool readDataFromLua_luaFunctionCall(const SLuaCallBack *p,
                                       const int *expectedArguments,
